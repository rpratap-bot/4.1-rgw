...
print(enable_epel)
print("----------------------------------------------------------------------")
install_python2_pip = os.system('yum install python2-pip -y')
print(install_python2_pip)
print("----------------------------------------------------------------------")
upgrade_pip = os.system('pip install --upgrade pip')
print(upgrade_pip)
print("----------------------------------------------------------------------")
install_s3cmd = os.system('pip install s3cmd')
print(install_s3cmd)
print("----------------------------------------------------------------------")
...
hostname = raw_input("Enter the hostname / machine-name, e.g-magna111: ")
port_number = raw_input("Enter the port number e.g-8080/80: ")
print(hostname)
print(port_number)
...
bkt_name = raw_input("Enter a bucket name that you want to create: ")
...
file_name = raw_input("Enter any file name you want to create of 100 MB: ")
